...
left join {{ ref('stg_etl_duplicate_token_transfer') }} dtk on tk.block_hash = dtk.blockhash 
...
left join {{ ref('stg_etl_phantom_token_transfer') }} ptk on tk.block_hash = ptk.blockhash 
...
and tk.block_timestamp between between {{ var('start_time') }} and {{ var('end_time') }} 